...
- [x] 8.1 实现入口包自动发现：从 entry_packages 自动扫描 Controller 的 Web 方法
- [x] 8.2 输出文件重命名为 code-graph.json 和 code-graph.html
- [x] 8.3 实现搜索入口方法并聚焦显示相关节点
- [x] 8.4 聚焦搜索与侧边栏开关同时生效
- [x] 8.5 修复 CONTAINS 边在过滤时被错误移除的问题
